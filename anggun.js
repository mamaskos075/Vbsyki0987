document.addEventListener('DOMContentLoaded', () => {
    ...
    const tutors = {
        '1': { name: 'Yona', education: 'S1 Universitas Brawijaya', tasks: '150+', description: '' },
        '2': { name: 'Zafina', education: 'S1 Universitas Brawijaya', tasks: '100+', description: '' },
        '3': { name: 'Adi', education: 'S1 Universitas Brawijaya', tasks: '120+', description: '' }
    };
